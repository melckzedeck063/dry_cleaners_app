      ...
      <View style={style.card} className="flex-row justify-between p-1 my-1 rounded-lg">
                ...
                <View>
                    ...
                    <View className="flex-row justify-between space-x-2">
                        ...
                        <View>
                        <Text style={{fontSize :  responsiveFontSize(2.5)}} className={`text-2xl text-slate-800 font-bold`}> 5 </Text>
                        </View>
                ...
                <View className="my-1 mt-3 pr-1.5">
                    <Text className={`text-slate-800 font-medium `}>Tsh 1000/item</Text>
